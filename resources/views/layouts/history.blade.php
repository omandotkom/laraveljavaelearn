<div class="main-content">
    <div class="container-fluid">
        <div class="row">
            ...
            <div id="carouselExampleIndicators" class="carousel slide mx-auto w-50 shadow-lg p-3 mb-5 bg-white rounded" data-ride="carousel">
                ...
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <img src="{{url('dashboardasset/img/java_logo_icon.png')}}" class="d-block w-100 img-fluid" alt="...">
                    </div>
                    <div class="carousel-item">
                        <img src="{{url('dashboardasset/img/james-gosling.jpg')}}" class="d-block w-100 img-fluid" alt="...">
                    </div>
                    <div class="carousel-item">
                        <img src="{{url('dashboardasset/img/james-gosling-1440w.jpg')}}" class="d-block w-100 img-fluid" alt="...">
                    </div>
                </div>
